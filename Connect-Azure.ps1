...
workflow Connect-Azure
{
    ...
    {
        Set-AzureSubscription -SubscriptionName $AzureConnectionName -SubscriptionId $AzureConn.SubscriptionID -Certificate $Certificate -ServiceEndpoint $ServiceEndpoint
    }
}